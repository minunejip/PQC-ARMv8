...
DUDECT_VISIBILITY void dudect_randombytes(uint8_t *x, size_t how_much);
DUDECT_VISIBILITY uint8_t dudect_randombit(void);
...
*/
#if defined(__x86_64__) || defined(_M_X64)
static inline int64_t dudect_cpucycles(void) {
  _mm_mfence();
